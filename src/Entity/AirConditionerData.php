 ...
 * AirConditionerData
 *
 * @ORM\Table(name="air_conditioner_data", indexes={@ORM\Index(name="fk_air_conditioner_data_visitors", columns={"visitors_id"}), @ORM\Index(name="fk_air_conditioner_data_service_description", columns={"service_description_id"})})
 * @ORM\Entity
 */
