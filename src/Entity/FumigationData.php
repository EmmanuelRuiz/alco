 ...
 * FumigationData
 *
 * @ORM\Table(name="fumigation_data", indexes={@ORM\Index(name="fk_fumigation_data_visitors", columns={"visitors_id"}), @ORM\Index(name="fk_fumigation_data_service_description", columns={"service_description_id"})})
 * @ORM\Entity
 */
