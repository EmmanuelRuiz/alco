 ...
 * SmithyData
 *
 * @ORM\Table(name="smithy_data", indexes={@ORM\Index(name="fk_smithy_data_data_visitors", columns={"visitors_id"}), @ORM\Index(name="fk_smithy_data_data_service_description", columns={"service_description_id"})})
 * @ORM\Entity
 */
class SmithyData
{
