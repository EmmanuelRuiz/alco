 ...
 * PaintData
 *
 * @ORM\Table(name="paint_data", indexes={@ORM\Index(name="fk_paint_data_visitors", columns={"visitors_id"}), @ORM\Index(name="fk_paint_data_service_description", columns={"service_description_id"})})
 * @ORM\Entity
 */
class PaintData
{
