 ...
 * PlumbingData
 *
 * @ORM\Table(name="plumbing_data", indexes={@ORM\Index(name="fk_plumbing_data_visitors", columns={"visitors_id"}), @ORM\Index(name="fk_plumbing_data_service_description", columns={"service_description_id"})})
 * @ORM\Entity
 */
class PlumbingData
{
