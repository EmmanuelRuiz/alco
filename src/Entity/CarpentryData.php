 ...
 * CarpentryData
 *
 * @ORM\Table(name="carpentry_data", indexes={@ORM\Index(name="fk_carpentry_data_visitors", columns={"visitors_id"}), @ORM\Index(name="fk_carpentry_data_service_description", columns={"service_description_id"})})
 * @ORM\Entity
 */
class CarpentryData
{
