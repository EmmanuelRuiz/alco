 ...
 * DrywallData
 *
 * @ORM\Table(name="drywall_data", indexes={@ORM\Index(name="fk_drywall_data_visitors", columns={"visitors_id"}), @ORM\Index(name="fk_drywall_data_service_description", columns={"service_description_id"})})
 * @ORM\Entity
 */
class DrywallData
{
