 ...
 * MasonryData
 *
 * @ORM\Table(name="masonry_data", indexes={@ORM\Index(name="fk_masonry_data_visitors", columns={"visitors_id"}), @ORM\Index(name="fk_masonry_data_service_description", columns={"service_description_id"})})
 * @ORM\Entity
 */
class MasonryData
{
