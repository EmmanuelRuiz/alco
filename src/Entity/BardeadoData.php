 ...
 * BardeadoData
 *
 * @ORM\Table(name="bardeados_data", indexes={@ORM\Index(name="fk_bardeados_data_visitors", columns={"visitors_id"}), @ORM\Index(name="fk_bardeados_data_service_description", columns={"service_description_id"})})
 * @ORM\Entity
 */
class BardeadoData
{
