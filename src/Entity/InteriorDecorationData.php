...
/**
 * InteriorDecorationData
 *
 * @ORM\Table(name="interior_decoration_data", indexes={@ORM\Index(name="fk_interior_decoration_data_visitors", columns={"visitors_id"}), @ORM\Index(name="fk_interior_decoration_data_service_description", columns={"service_description_id"})})
 * @ORM\Entity
 */
class InteriorDecorationData
{
    /**
     * @var int
     *
    ...
    public function setVisitors(?Visitor $visitor): self
    {
