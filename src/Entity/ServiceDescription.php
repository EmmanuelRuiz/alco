 ...
 * ServiceDescription
 *
 * @ORM\Table(name="service_description", indexes={@ORM\Index(name="fk_service_description_service_category", columns={"service_category_id"}), @ORM\Index(name="fk_service_description_users", columns={"users_id"})})
 * @ORM\Entity
 */
