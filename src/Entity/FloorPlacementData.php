 ...
 * FloorPlacementData
 *
 * @ORM\Table(name="floor_placement_data", indexes={@ORM\Index(name="fk_floor_placement_data_visitors", columns={"visitors_id"}), @ORM\Index(name="fk_floor_placement_data_service_description", columns={"service_description_id"})})
 * @ORM\Entity
 */
class FloorPlacementData
{
    /**
     * @var int
     *
