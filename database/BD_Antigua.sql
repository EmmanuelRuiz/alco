...
CREATE TABLE estimate(
	...
	CONSTRAINT fk_estimate_service_description FOREIGN KEY(service_description_id) references service_description(id),
...
CREATE TABLE air_conditioner_data(
	...
	CONSTRAINT fk_air_conditioner_data_service_description FOREIGN KEY(service_description_id) references service_description(id),
...
CREATE TABLE paint_data(
	...
	CONSTRAINT fk_paint_data_service_description FOREIGN KEY(service_description_id) references service_description(id),
...
CREATE TABLE waterproofing_data(
	...
	CONSTRAINT fk_waterproofing_data_service_description FOREIGN KEY(service_description_id) references service_description(id),
...
CREATE TABLE bardeados_data(
	...
	CONSTRAINT fk_bardeados_data_service_description FOREIGN KEY(service_description_id) references service_description(id),
...
CREATE TABLE drywall_data(
	...
	CONSTRAINT fk_drywall_data_service_description FOREIGN KEY(service_description_id) references service_description(id),
...
CREATE TABLE floor_placement_data(
	...
	CONSTRAINT fk_floor_placement_data_service_description FOREIGN KEY(service_description_id) references service_description(id),
...
CREATE TABLE smithy_data(
	...
	CONSTRAINT fk_smithy_data_data_service_description FOREIGN KEY(service_description_id) references service_description(id),
...
CREATE TABLE plumbing_data(
	...
	CONSTRAINT fk_plumbing_data_service_description FOREIGN KEY(service_description_id) references service_description(id),
...
CREATE TABLE masonry_data(
	...
	CONSTRAINT fk_masonry_data_service_description FOREIGN KEY(service_description_id) references service_description(id),
...
CREATE TABLE interior_decoration_data(
	...
	CONSTRAINT fk_interior_decoration_data_service_description FOREIGN KEY(service_description_id) references service_description(id),
...
CREATE TABLE carpentry_data(
	...
	CONSTRAINT fk_carpentry_data_service_description FOREIGN KEY(service_description_id) references service_description(id),
...
CREATE TABLE fumigation_data(
	...
	CONSTRAINT fk_fumigation_data_service_description FOREIGN KEY(service_description_id) references service_description(id),
...
CREATE TABLE electricity_data(
	...
	CONSTRAINT fk_electricity_data_service_description FOREIGN KEY(service_description_id) references service_description(id),
